  ...
  return (
    <div>
      <div className="max-w-[856px]">
        <div
          className={`flex gap-8 p-5 border-b-2 border-neutral-200 ${index === 0 ? "border-t-2" : ""}`}
        >
          <Image
            src={numberImg}
            alt={`No.${index + 1} logo`}
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="font-medium text-desktop-body3">{answer}</p>
          </div>
        </div>
      </div>
    </div>
        ...
        },
        {
          ...
          answer: (
            <>
              ...
              。一樣也是提供<span className="font-bold">免費培訓</span>
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <>
              A：我們的培訓流程，主要是將學員培育成
              <span className="font-bold">「擁有自我解決問題的工程師」</span>
